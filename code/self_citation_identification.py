...
class self_citation():
    ...
    def __parse_line(self, line, au, cr, pa, py, er, author_list, citation_list, year, location):
        ...
        return au, cr, pa, py, er, article_info
    ...
    def article_info_from_text(self):
        ...
        for file in self.files:
            ...
            for line in text:
                au, cr, pa, py, er, article_info = self.__parse_line(line, au, cr, pa, py, er, author_list, citation_list, year, location)
